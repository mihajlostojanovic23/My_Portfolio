...
import MiniPtojects from './Mini_Projects.png'
import ViewPage from './page-views.png'   
...
page: 'https://night-and-day-official.netlify.app/'    },
...
page: 'https://weather-official.netlify.app/'    },
...
page: 'https://to-do-list-official.netlify.app/' },
...
page: 'https://rock-paper-scissors-official.netlify.app/' },
...
page: 'https://portfolio-official.netlify.app/' },

{
  Name: 'Movie App',
  Picture: Movie ,
  Description: 'Another project where my main focus was to learn API handling. This application contains the home page, trending movies as well as the ability to search for a specific movie. By clicking on a specific movie, details are read',
  Link: 'https://github.com/mihajlostojanovic23/Movie_App',
  Tools: [
  {tool: 'React' },
  {tool: 'Netlify'}
],
page:'https://movies-official.netlify.app/' },
{
  Name: 'Memory Game',
  Picture: Memory ,
  Description: 'This is a project where I wanted to make some kind of game like a memory game. I made a game using React and my main goal was to learn how to create animations as well as assign a class if a condition is met',
  Link: 'https://github.com/mihajlostojanovic23/Memory_App',
  Tools: [
  {tool: 'React' },
  {tool: 'Netlify'}
],
...
{
  Name: 'Mini Projects',
  Picture: MiniPtojects ,
  Description: 'Here are some projects I created to refresh and solidify my knowledge',
  Link: 'https://github.com/mihajlostojanovic23/Mini_Projects',
  Tools: [
  {tool: 'HTML' },
  {tool: 'CSS'},
  {tool: 'JavaScript'}
...
page: '' },
  ...
  return (
    <div className='links'>
        ...
        <h2 className='projects_title'>Some projects</h2>
    ...
    return <div className='project'>
          ...
          {info.page != ''?  <div className='app_page'><a target='blank' href={info.page}><img className='photo_view_page'  src={ViewPage} /></a></div>  : <div> </div>}
</div>
               </a>
